export default function GraphWrapper({
    ...
    return (
        <div className={`group ${isAlwaysTitle && "pt-8"} relative overflow-hidden h-full w-full bg-gradient-to-br from-zinc-800 to-zinc-850 rounded-lg border border-zinc-700/50 hover:border-zinc-600/80 ` + classes}>
